...
import com.todolist.todo.documentation.AdministradorControllerDocumentation;
...
public class AdministradorController implements AdministradorControllerDocumentation {
    ...
    public ResponseEntity<RolResponseDTO> editarRol(@PathVariable String rolNombre
